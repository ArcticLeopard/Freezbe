...
public class AssignmentTests
{
    ...
    public void Constructor_WithValidAttribues_ShouldPropertiesInitializedCorrectly()
    {
        ...
        var assignment = new Assignment(assignmentId, description, createdAt, assignmentStatus, false, null);
    ...
    public void ChangeDescription_WhenCalledWithNewDescription_DescriptionPropertyShouldBeUpdated()
    {
        ...
        var assignment = new Assignment(assignmentId, initialDescription, dateTimeOffset, AssignmentStatus.Active, false, null);
    ...
    public void Abandon_ShouldChangeAssignmentStatusToAbandon(string startedState)
    {
        ...
        var description = new Description("Initial description");
        var createdAt = _fakeTimeProvider.GetUtcNow();
        var assignment = new Assignment(assignmentId, description, createdAt, startedState, false, null);
        // ACT
    ...
    public void IncreasePriority_ShouldChangePriorityValueToTrue()
    {
        ...
        var assignment = new Assignment(assignmentId, description, createdAt, AssignmentStatus.Active, false, null);
    ...
    public void DecreasePriority_ShouldChangePriorityValueToFalse()
    {
        ...
        var assignment = new Assignment(assignmentId, description, createdAt, AssignmentStatus.Active, true, null);
