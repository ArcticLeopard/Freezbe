...
public class DeleteSpaceCommandHandlerTests
{
    ...
    public DeleteSpaceCommandHandlerTests()
    {
    ...
    public async Task HandleAsync_ValidCommand_SuccessfullyDeleteSpace()
    {
        ...
        var handler = new DeleteSpaceCommandHandler(spaceRepositoryMock.Object);
    ...
    public async Task HandleAsync_WhenSpaceDoesNotExist_ThrowsSpaceNotFoundException()
    {
        ...
        var command = new DeleteSpaceCommand(assignmentId);
        ...
        var handler = new DeleteSpaceCommandHandler(assignmentRepositoryMock.Object);
