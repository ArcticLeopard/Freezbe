...
public class AssignmentHardDeleteCommandHandlerTests
{
    private readonly TimeProvider _fakeTimeProvider;

    public AssignmentHardDeleteCommandHandlerTests()
    {
    ...
    public async Task HandleAsync_ValidCommand_SuccessfullyDeleteAssignment()
    {
        ...
        var command = new AssignmentHardDeleteCommand(assignmentId);
        ...
        var handler = new AssignmentHardDeleteCommandHandler(assignmentRepositoryMock.Object);
