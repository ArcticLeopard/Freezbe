...
internal class GetAssignmentsForProjectQueryHandler : IRequestHandler<GetAssignmentsFromProjectQuery, IEnumerable<AssignmentDto>>
{
    ...
    public async Task<IEnumerable<AssignmentDto>> Handle(GetAssignmentsFromProjectQuery request, CancellationToken cancellationToken)
    {
